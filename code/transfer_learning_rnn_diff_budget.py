...
hidden_size_1=128
hidden_size_2=256
note = f'''Transfer Learning - Test all 48 cities, from 40k budget best model, 50,000ep'''
    ...
    for num_episode in num_episodes:
        for budget in budgets:
            for i in range(1):
                ...
                path="project/code/model/rnn/city_48/test_0.04/episode_50000/num_test_0/model_size_128_256/batch_32_lr_0.001_memoryBuffer_400000/starting_city_0/budget_40000/num_test_0/best_model.tar"
