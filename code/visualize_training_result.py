...
for city in cities:
    for budget in budgets:
        ...
        path = f"project/code/model/rnn/city_48/test_250/budget_{budget}/starting_city_{city}/total_ep_5010/num_test_0/training_data_each_episode.csv"
        ...
        marl_v2_df = pd.read_csv('project/code/model/marl_v2/test_250/ep_5000_5000/budget_2000_10000/num_agent_5_5/training/marl_10_city.csv')
        ...
        marl_v1_df = pd.read_csv("project/code/model/marl_v1/test_250.1/ep_5000_5000/budget_10000_10000/num_agent_5_5/training/marl_10_city.csv")
        ...
        plt.tight_layout()
        plt.savefig(f'copy_training_reward_comparison_antQ_PMARL_RNN_{budget}_budget_starting_city_{city}_running_avg_data_w_2000.pdf')
        plt.show()
