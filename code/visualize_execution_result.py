...
marl_v1_df = pd.read_csv("project/code/model/marl_v1/test_250.1/ep_5000_5000/budget_10000_10000/num_agent_5_5/execution/marl_10_city.csv")
...
#     for budget in budgets:
        rnn_pred_df = pd.read_csv(f"project/code/model/rnn/city_48/starting_city_{city}/test_250.1/prediction_data.csv")
        ...
        for graph_type in graph:
                if graph_type == 'reward':
                        ...
                        plt.tight_layout()
                        plt.savefig(f"copy_antQ_marl_rnn_comparison_total_prize_starting_city_{city}.png") 
                        plt.show()
                if graph_type == 'distance':
                        ...
                        plt.legend(fontsize="15")
                        plt.tight_layout()
                        plt.savefig(f"copy_antQ_marl_rnn_comparison_distance_traveled_starting_city_{city}.png") 
                        plt.show()
                if graph_type == 'time':
                        ...
                        plt.legend(fontsize="15")
                        plt.tight_layout()
                        plt.savefig(f"copy_antQ_marl_rnn_comparison_execute_time_starting_city_{city}.png") 
                        plt.show()
