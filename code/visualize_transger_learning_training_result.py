...
for city in cities:
    for budget in budgets:
        ...
        marl_v1_transfer = pd.read_csv('project/code/transfer_learning/marl_v1/test_1/ep_5000_5000/num_agent_5/based_budget_6000_model/train_10000/training/marl_all_city.csv')
        ...
        plt.tight_layout()
        plt.savefig(f'result_different_city/transfer_learning/P-MARL_based_model_6k_budget_transfer_10k_budget.pdf')
        plt.show()
